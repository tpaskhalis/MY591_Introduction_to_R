...
## <footnote content="The original version of the slides was created by [Jack Blumenau](https://www.jackblumenau.com/)">Materials</footnote>
...
ggplot(r2.compare, aes(x = model, y = r.squared))+
  geom_point(size = 4) +
  # Use `expression` to add 2 as superscript to R
...
- Crawley, M. J. (2012). *The R Book* (2nd edition). Hoboken, NJ: Wiley-Blackwell.
- Dalgaard, P. (2008). Introductory Statistics with R. 2nd Ed. Heidelberg: Springer.
- Fox, J. (2018). *An R Companion to Applied Regression* (3rd edition). Thousand Oaks, CA: Sage Publications.
